...
public class Association
{
    ...
    {
    	Address ad1=new Address("#100,Sector1","Chandigarh","Chandigarh");
    	Employee emp1=new   Employee("101","deepu",ad1);
    	emp1.showEmpDetails();
    	
    	Address ad2=new Address("#200,Sector2","Faridabad","Haryana");
    	Employee emp2=new   Employee("102","pundu",ad2);
    	emp2.showEmpDetails();
